...
public class NaturalRepCommand extends IRepCommand {
  ...
  public NaturalRepCommand(BungeeMain plugin) {
    ...
    super.addSyntax(Permissions.REP_NATURAL, false, false, "/rep <name> <amount> <reason>",
    ...
    super.addSyntax(Permissions.REP_NATURAL, false, false, "/rep <name>", "View player info.");
  }
