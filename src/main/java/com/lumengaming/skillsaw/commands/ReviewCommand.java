...
//<editor-fold defaultstate="collapsed" desc="review request class">
    private class ReviewRequest {
         ...
         * @param isProReview	-- specifies whether or not review requests will be shown as red to all instructors.
         */
        ...
        /**
         * only compares the name of the requester, because there will only be one request per user at any given time. *
         */
        @Override
        ...
        /**
         * terrible method name, I know. Basically just use this method to log a teleport to this review request. *
         */
